class HashStorage {
    ...
    deleteValue(key) {
      if(key in this.magazine) {
        return delete this.magazine[key];
      };
    ...
    getKeys() {
      return Object.keys(this.magazine);
    };
  };
...
allCoctailsButton.onclick = function() {
    alert(`Весь список коктейлей: ${coctailsStorage.getKeys()}`) 
};
